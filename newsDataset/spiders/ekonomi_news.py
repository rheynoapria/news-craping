...
import re
import unicodedata
from newsDataset.items import EkonomiNewsItem

class EkonomiNewsSpider(scrapy.Spider):
    name = 'ekonomi-news'
    allowed_domains = ['gatra.com']
    api_url = 'https://www.gatra.com/rubrik/get_news?c=2&barisnya={}'
