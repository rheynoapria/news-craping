...
import re
import unicodedata
from newsDataset.items import KesehatanNewsItem

class KesehatanNewsSpider(scrapy.Spider):
    name = 'kesehatan-news'
    allowed_domains = ['gatra.com']
    api_url = 'https://www.gatra.com/rubrik/get_news?c=6&barisnya={}'
